...
urlpatterns = [
    ...
    path(
        "tenant/<int:user_id>/<int:property_id>/",
        views.tenant_property_page,
        name="tenant_property_page",
    ),
    path(
        "tenant_enquiry/<int:user_id>/<int:property_id>",
        views.send_enquiry,
        name="send_enquiry",
    ),
]
